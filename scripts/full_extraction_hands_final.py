...
subcategories_group2 = ["absent_left_hand", "absent_right_hand", "absent_pose", "absent_face"]
...
def extract_hands(results, frame_width, frame_height):
    # Swapped perspective: Interpret Mediapipe's "Left" as "Right" and vice versa
...
for video_file in os.listdir(dataset_dir):
    ...
    with mp_hands.Hands(min_detection_confidence=0.2, min_tracking_confidence=0.2) as hands, \
        ...
        while cap.isOpened():
            ...
            has_pose, pose_keypoints = extract_pose(results_pose, frame_width, frame_height)
